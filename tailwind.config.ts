...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        glow: "0 0 40px hsl(var(--primary) / 0.3), 0 0 80px hsl(var(--secondary) / 0.2)",
        "glow-sm": "0 0 20px hsl(var(--primary) / 0.2)",
        "glow-lg": "0 0 60px hsl(var(--primary) / 0.4), 0 0 120px hsl(var(--secondary) / 0.3)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { 
            boxShadow: "0 0 40px hsl(var(--primary) / 0.6), 0 0 80px hsl(var(--secondary) / 0.4)"
          },
        },
        shimmer: {
