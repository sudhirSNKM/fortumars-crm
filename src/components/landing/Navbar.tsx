           ...
           <div className="flex items-center justify-between">
             ...
             >
               <div className="relative">
                 ...
                 <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-primary via-secondary to-accent blur-lg opacity-50 group-hover:opacity-75 transition-opacity" />
               </div>
